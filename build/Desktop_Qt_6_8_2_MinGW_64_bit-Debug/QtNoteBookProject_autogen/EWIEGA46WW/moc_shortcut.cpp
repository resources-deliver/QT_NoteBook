...
static constexpr auto qt_meta_stringdata_ZN8ShortCutE = QtMocHelpers::stringData(
    "ShortCut"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8ShortCutE[] = {
...
Q_CONSTINIT const QMetaObject ShortCut::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8ShortCutE.offsetsAndSizes,
    qt_meta_data_ZN8ShortCutE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8ShortCutE_t,
        // Q_OBJECT / Q_GADGET
...
void *ShortCut::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8ShortCutE.stringdata0))
